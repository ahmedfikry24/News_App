...
class CustomScienceListView extends StatelessWidget {
  const CustomScienceListView({super.key});
      ...
      builder: (controller) => RefreshIndicator(
        ...
        child: ListView.separated(
            itemBuilder: (context, index) => InkWell(
                  onTap: () {
                    controller.goToWebView(controller.science[index]['url'] ??
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          imageUrl: controller.science[index]['urlToImage'] ??
                          ...
                          child: Column(
                            ...
                            children: [
                              Flexible(
                                flex: 1,
                                child: Text(
                                  controller.science[index]['title'] ??
                              ...
                              Flexible(
                                flex: 1,
                                child: Text(
                                  controller.science[index]['description'] ??
                              ...
                              Flexible(
                                flex: 1,
                                child: Text(
                                  controller.science[index]['publishedAt'] ??
